      ...
      setTimeout(async () => {
        try {
          ...
          if (!scannerContainerRef.current) {
            ...
            throw new Error(
              "Could not initialize QR scanner. Please try again.",
            );
          }
          ...
          try {
            await scannerRef.current.start(
              ...
              (errorMessage) => {
                ...
                console.log(
                  `QR scan in progress, frame error: ${errorMessage}`,
                );
              },
            );
            ...
            toast({
              title: "Scanner Ready",
              description:
                "QR code scanner is now active. Point your camera at a QR code.",
            });
            ...
            if (newAttemptCount < 3) {
              console.log(
                `Retrying scanner initialization (attempt ${newAttemptCount + 1})...`,
              );
          ...
          if (
            ...
            toast({
              title: "Scanner Error",
              description:
                "Could not start the QR code scanner. You can use manual entry instead.",
              variant: "destructive",
            });
  ...
  return (
    <>
            ...
            {isScanning ? (
              <div className="space-y-4">
                ...
                <div className="relative border rounded-md overflow-hidden">
                  <div ref={scannerContainerRef} className="w-full h-[300px]" />
                ...
                {!scanResult ? (
                  <div className="flex flex-col items-center space-y-4 p-4 text-center">
                    ...
                    <p className="text-muted-foreground max-w-md">
                      Click the button below to start scanning QR codes. Make
                              ...
                              <div className="mt-3 bg-white p-3 rounded-md shadow-sm">
                                <div className="flex items-center mb-2">
                                  ...
                                  <div>
                                    ...
                                    {scanResult.registration.participants &&
                                      scanResult.registration.participants >
                                        1 && (
                                ...
                                <div className="grid grid-cols-2 gap-2 text-xs">
                                  ...
                                  <div>
                                    ...
                                    <p>
                                      {scanResult.registration.waiverSigned
                                        ? "Yes"
                                        : event.waiver
                                          ? "No"
                                          : "Not Required"}
                                ...
                                <div className="mt-3 flex flex-col gap-1 text-xs">
                                  ...
                                  <p className="p-1 bg-black/5 rounded break-all">
                    ...
                    {useManualInput && (
                      <div className="border rounded-md p-4">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">
                          Enter the QR code data manually if the scanner is not
                          working.
                        </p>
      ...
      {scanResult && (
        <ScanNotification
          type={
            scanResult.success && scanResult.registration ? "success" : "error"
          }
